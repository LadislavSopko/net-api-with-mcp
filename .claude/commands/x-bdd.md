...
description: Setup BDD mindset (list of rules)
---

## Your task

- Read MB skip progerss and docs subdir
- Read .claude/commands/mind-sets/csharp-senior.md also eventual other indicated files.
- Read .claude/commands/mind-sets/bdd-developer.md also eventual other indicated files.