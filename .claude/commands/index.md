...
## UI & Visual Commands (1)
| Command | Purpose | Key Flags |
|---------|---------|-----------|
| /user:uidbg | Visual UI debugging | --route --size --element --focus --model |
...
---
*SuperClaude v4.0.0 - 19 commands with comprehensive configuration framework*