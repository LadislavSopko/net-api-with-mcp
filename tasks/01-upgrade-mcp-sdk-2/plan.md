...
- Test stack: `xunit.v3` 4.0.1 + `xunit.runner.visualstudio` 4.0.0 + `Microsoft.NET.Test.Sdk` 18.10.0 (kept for IDE), `AwesomeAssertions` 9.6.0 (namespace stays `FluentAssertions`, so `using FluentAssertions;` compiles unchanged), `NSubstitute` 6.2.0 (Moq removed).
